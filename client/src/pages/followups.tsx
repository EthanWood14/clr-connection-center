...
function FollowUpCard({
  ...
  return (
    <Card
      ...
      data-testid={`card-followup-${outcome.id}`}
    >
...
export default function FollowUps() {
  ...
  const rescheduleMutation = useMutation({
    ...
    onError: () => {
      setPendingRescheduleId(null);
      toast({ title: "Error rescheduling follow-up", variant: "destructive" });
    },
  });
    ...
    <div className="p-6 space-y-6 max-w-3xl mx-auto">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">
          Leads that need a follow-up call today or are overdue
        </p>
      </div>
          ...
          <CardContent className="py-16 flex flex-col items-center gap-3 text-center">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                No follow-ups are due today. Check back tomorrow.
              </p>
            </div>
          </CardContent>
        </Card>
