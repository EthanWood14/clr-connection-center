...
const RAW: Omit<TestQuestion, "id">[] = [
  ...
  { day: 2, text: "Why have the trainee fill in a blank info sheet while listening to a call?", choices: ["It builds muscle memory for when they get on the phones", "It scores the trainer's performance on the call", "It replaces the roleplay session", "It is required before Quiz #2"], correct: 0, why: "Let them listen to a call and jot the information down on their own blank sheet. This builds muscle memory when they get on the phones." },
